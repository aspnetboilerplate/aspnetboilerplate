...
namespace Abp.Castle.Logging.Log4Net
{
        ...
        ILogger
    {
        ...
        {
            if (IsTraceEnabled) Logger.Log(DeclaringType, Level.Trace, message, null);
        }

        public void Trace(Func<string> messageFactory)
        {
            if (IsTraceEnabled) Logger.Log(DeclaringType, Level.Trace, messageFactory.Invoke(), null);
        }

        public void Trace(string message, Exception exception)
        {
            if (IsTraceEnabled) Logger.Log(DeclaringType, Level.Trace, message, exception);
        }
        ...
        {
            if (IsDebugEnabled) Logger.Log(DeclaringType, Level.Debug, message, null);
        }

        public void Debug(Func<string> messageFactory)
        {
            if (IsDebugEnabled) Logger.Log(DeclaringType, Level.Debug, messageFactory.Invoke(), null);
        }

        public void Debug(string message, Exception exception)
        {
            if (IsDebugEnabled) Logger.Log(DeclaringType, Level.Debug, message, exception);
        }
        ...
        {
            if (IsErrorEnabled) Logger.Log(DeclaringType, Level.Error, message, null);
        }

        public void Error(Func<string> messageFactory)
        {
            if (IsErrorEnabled) Logger.Log(DeclaringType, Level.Error, messageFactory.Invoke(), null);
        }

        public void Error(string message, Exception exception)
        {
            if (IsErrorEnabled) Logger.Log(DeclaringType, Level.Error, message, exception);
        }
        ...
        {
            if (IsFatalEnabled) Logger.Log(DeclaringType, Level.Fatal, message, null);
        }

        public void Fatal(Func<string> messageFactory)
        {
            if (IsFatalEnabled) Logger.Log(DeclaringType, Level.Fatal, messageFactory.Invoke(), null);
        }

        public void Fatal(string message, Exception exception)
        {
            if (IsFatalEnabled) Logger.Log(DeclaringType, Level.Fatal, message, exception);
        }
        ...
        {
            if (IsInfoEnabled) Logger.Log(DeclaringType, Level.Info, message, null);
        }

        public void Info(Func<string> messageFactory)
        {
            if (IsInfoEnabled) Logger.Log(DeclaringType, Level.Info, messageFactory.Invoke(), null);
        }

        public void Info(string message, Exception exception)
        {
            if (IsInfoEnabled) Logger.Log(DeclaringType, Level.Info, message, exception);
        }
        ...
        {
            if (IsWarnEnabled) Logger.Log(DeclaringType, Level.Warn, message, null);
        }

        public void Warn(Func<string> messageFactory)
        {
            if (IsWarnEnabled) Logger.Log(DeclaringType, Level.Warn, messageFactory.Invoke(), null);
        }

        public void Warn(string message, Exception exception)
        {
            if (IsWarnEnabled) Logger.Log(DeclaringType, Level.Warn, message, exception);
        }
