    ...
    where TUser : AbpUser<TUser>
{
    ...
    private IRolePermissionStore<TRole> RolePermissionStore
    {
        get
        {
            if (!(Store is IRolePermissionStore<TRole>)) throw new AbpException("Store is not IRolePermissionStore");
    ...
    {
        if (role.IsStatic) throw new UserFriendlyException(string.Format(L("CanNotDeleteStaticRole"), role.Name));
