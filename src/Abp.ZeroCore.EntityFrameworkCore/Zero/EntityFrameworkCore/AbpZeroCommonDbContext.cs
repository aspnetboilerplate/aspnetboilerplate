    ...
    where TSelf : AbpZeroCommonDbContext<TRole, TUser, TSelf>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ApplicationLanguage>(b => { b.HasIndex(e => new { e.TenantId, e.Name }); });
        ...
        modelBuilder.Entity<OrganizationUnit>(b => { b.HasIndex(e => new { e.TenantId, e.Code }).IsUnique(false); });

        modelBuilder.Entity<PermissionSetting>(b => { b.HasIndex(e => new { e.TenantId, e.Name }); });
        ...
        modelBuilder.Entity<TRole>(b => { b.HasIndex(e => new { e.TenantId, e.NormalizedName }); });
        ...
        modelBuilder.Entity<TenantNotificationInfo>(b => { b.HasIndex(e => new { e.TenantId }); });

        modelBuilder.Entity<UserClaim>(b => { b.HasIndex(e => new { e.TenantId, e.ClaimType }); });
        ...
        modelBuilder.Entity<UserNotificationInfo>(b => { b.HasIndex(e => new { e.UserId, e.State, e.CreationTime }); });
        ...
        modelBuilder.Entity<UserToken>(b => { b.HasIndex(e => new { e.TenantId, e.UserId }); });

        modelBuilder.Entity<DynamicProperty>(b => { b.HasIndex(e => new { e.PropertyName, e.TenantId }).IsUnique(); });
        ...
        modelBuilder.Entity<UserLogin>(b => { b.HasIndex(e => new { e.ProviderKey, e.TenantId }).IsUnique(); });
