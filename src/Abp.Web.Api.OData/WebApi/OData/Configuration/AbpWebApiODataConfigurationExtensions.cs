...
namespace Abp.WebApi.OData.Configuration
{
    ...
    public static class AbpWebApiODataConfigurationExtensions
    {
        ...
        {
            return configurations.AbpConfiguration.GetOrCreate("Modules.Abp.Web.Api.OData",
                () => configurations.AbpConfiguration.IocManager.Resolve<IAbpWebApiODataModuleConfiguration>());
        }
    }
}