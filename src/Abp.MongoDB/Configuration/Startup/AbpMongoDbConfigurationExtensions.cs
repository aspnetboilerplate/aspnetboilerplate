...
namespace Abp.Configuration.Startup
{
    ...
    public static class AbpMongoDbConfigurationExtensions
    {
        ...
        {
            return configurations.AbpConfiguration.GetOrCreate("Modules.Abp.MongoDb",
                () => configurations.AbpConfiguration.IocManager.Resolve<IAbpMongoDbModuleConfiguration>());
        }
    }
}