...
namespace Abp.IdentityFramework
{
    public static class IdentityResultExtensions
    {
        ...
        public static string LocalizeErrors(this IdentityResult identityResult,
            ILocalizationManager localizationManager, string localizationSourceName)
        {
            ...
            if (identityResult is AbpIdentityResult) return identityResult.Errors.JoinAsString(" ");
