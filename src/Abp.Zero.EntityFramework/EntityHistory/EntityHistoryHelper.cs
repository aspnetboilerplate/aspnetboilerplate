    ...
    public class EntityHistoryHelper : EntityHistoryHelperBase, IEntityHistoryHelper, ITransientDependency
    {
        ...
        public virtual EntityChangeSet CreateEntityChangeSet(DbContext context)
        {
            ...
            foreach (var entityEntry in context.ChangeTracker.Entries())
            {
                ...
                if (!IsTypeOfEntity(typeOfEntity)) continue;
        ...
        {
            if (elementTypeName == entityEdmType.Name) return true;
            ...
            EntitySet entitySet, bool auditedPropertiesOnly)
        {
            ...
            {
                if (entityType.KeyProperties.Any(m => m.Name == property.Name)) continue;
            ...
            bool auditedPropertiesOnly)
        {
            ...
            foreach (var relationship in relationshipGroups)
            {
                ...
                {
                    Logger.ErrorFormat("Unable to find navigation property for relationship {0} in entity {1}",
                        relationshipName, entityType.Name);
                    continue;
                }
        ...
        private void UpdateChangeSet(DbContext context, EntityChangeSet changeSet)
        {
            ...
            foreach (var entityChange in changeSet.EntityChanges)
            {
                ...
                /* Update entity id */
                var entityType = GetEntityType(objectContext, typeOfEntity, false);
