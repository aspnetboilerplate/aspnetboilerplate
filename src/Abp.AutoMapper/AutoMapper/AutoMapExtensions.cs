...
namespace Abp.AutoMapper
{
    public static class AutoMapExtensions
    {
        ...
        [Obsolete(
            "Automapper will remove static API, Please use ObjectMapper instead. See https://github.com/aspnetboilerplate/aspnetboilerplate/issues/4667")]
        public static TDestination MapTo<TDestination>(this object source)
        {
            return AbpEmulateAutoMapper.Mapper != null
                ? AbpEmulateAutoMapper.Mapper.Map<TDestination>(source)
        ...
        {
            return AbpEmulateAutoMapper.Mapper != null
                ? AbpEmulateAutoMapper.Mapper.Map(source, destination)
                : default(TDestination);
        }
            ...
            where TMultiLingualEntity : IMultiLingualEntity<TTranslation>
        {
            ...
            result.EntityMap = configuration.CreateMap<TMultiLingualEntity, TDestination>().BeforeMap(
                (source, destination, context) =>
                {
                    if (source.Translations.IsNullOrEmpty()) return;
                    ...
                    var defaultLanguage =
                        multiLingualMapContext.SettingManager.GetSettingValue(LocalizationSettingNames.DefaultLanguage);
                    ...
                    if (translation != null) context.Mapper.Map(translation, destination);
                });
            ...
            where TTranslation : class, IEntityTranslation<TMultiLingualEntity, TMultiLingualEntityPrimaryKey>
        {
            if (culture == null || culture.Name.IsNullOrWhiteSpace() || translations.IsNullOrEmpty() ||
                currentDepth > MaxCultureFallbackDepth) return null;
