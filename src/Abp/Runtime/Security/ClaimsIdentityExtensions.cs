...
namespace Abp.Runtime.Security
{
    public static class ClaimsIdentityExtensions
    {
        ...
        public static int? GetTenantId(this IIdentity identity)
        {
            ...
            if (tenantIdOrNull == null || tenantIdOrNull.Value.IsNullOrWhiteSpace()) return null;
        ...
        public static int? GetImpersonatorTenantId(this IIdentity identity)
        {
            ...
            var tenantIdOrNull =
                claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == AbpClaimTypes.ImpersonatorTenantId);
            if (tenantIdOrNull == null || tenantIdOrNull.Value.IsNullOrWhiteSpace()) return null;
