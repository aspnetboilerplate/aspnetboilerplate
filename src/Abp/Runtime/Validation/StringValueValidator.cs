...
namespace Abp.Runtime.Validation
{
    ...
    public class StringValueValidator : ValueValidatorBase
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (MinLength > 0 && strValue.Length < MinLength) return false;

            if (MaxLength > 0 && strValue.Length > MaxLength) return false;

            if (!RegularExpression.IsNullOrEmpty()) return Regex.IsMatch(strValue, RegularExpression);
