...
namespace Abp.DynamicEntityProperties.Extensions
{
    public static class DynamicEntityPropertyManagerExtensions
    {
        ...
        public static DynamicEntityProperty Add<TEntity>(this IDynamicEntityPropertyManager manager,
            int dynamicPropertyId, int? tenantId)
            where TEntity : IEntity<int>
        {
        ...
        public static async Task<DynamicEntityProperty> AddAsync<TEntity, TPrimaryKey>(
            this IDynamicEntityPropertyManager manager, int dynamicPropertyId, int? tenantId)
            where TEntity : IEntity<TPrimaryKey>
        {
            var entity = new DynamicEntityProperty()
            {
        ...
        public static DynamicEntityProperty Add<TEntity>(this IDynamicEntityPropertyManager manager,
            DynamicProperty dynamicProperty, int? tenantId)
            where TEntity : IEntity<int>
        {
        ...
        public static Task<DynamicEntityProperty> AddAsync<TEntity, TPrimaryKey>(
            this IDynamicEntityPropertyManager manager, DynamicProperty dynamicProperty, int? tenantId)
            where TEntity : IEntity<TPrimaryKey>
        {
