...
namespace Abp.MimeTypes
{
    public class MimeTypeMap : IMimeTypeMap, ITransientDependency
    {
        ...
        public virtual string GetMimeType(string str, bool throwErrorIfNotFound = true)
        {
            ...
            if (TryGetMimeType(str, out var result)) return result;

            if (throwErrorIfNotFound) throw new ArgumentException("Requested mime type is not registered for: " + str);
        ...
        public virtual string GetExtension(string mimeType, bool throwErrorIfNotFound = true)
        {
            ...
            if (TryGetExtension(mimeType, out string extension)) return extension;
        ...
        public void AddMimeType(string mimeType, string extension)
        {
            ...
            if (mimeType.StartsWith(Dot)) throw new ArgumentException("MIME type should not start with dot");

            if (!extension.StartsWith(Dot)) throw new ArgumentException("Extensions should start with dot");
        ...
        public void RemoveMimeType(string mimeType)
        {
            ...
            if (MappingDictionary.Value.ContainsKey(mimeType)) MappingDictionary.Value.Remove(mimeType);
        }
        ...
        public void RemoveExtension(string extension)
        {
            ...
            if (MappingDictionary.Value.ContainsKey(extension)) MappingDictionary.Value.Remove(extension);
        }
    }
}