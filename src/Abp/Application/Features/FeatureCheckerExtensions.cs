...
namespace Abp.Application.Features
{
    ...
    public static class FeatureCheckerExtensions
    {
        ...
        ///
        /// This is a shortcut for <see cref="GetValue(IFeatureChecker, Guid, string)"/> that uses <see cref="IAbpSession.TenantId"/> as tenantId.
        ...
        /// <summary>
        /// Gets value of a feature by it's name. This is sync version of <see cref="IFeatureChecker.GetValueAsync(Guid, string)"/>
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker"/> instance</param>
        ...
        ///
        /// This is a shortcut for <see cref="IsEnabledAsync(IFeatureChecker, Guid, string)"/> that uses <see cref="IAbpSession.TenantId"/> as tenantId.
        /// So, this method should be used only if TenantId can be obtained from the session.
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker"/> instance</param>
        /// <param name="featureName">Unique feature name</param>
