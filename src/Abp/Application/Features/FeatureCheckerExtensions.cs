...
namespace Abp.Application.Features
{
    ...
    public static class FeatureCheckerExtensions
    {
        ...
        ///     This is a shortcut for <see cref="GetValue(IFeatureChecker, Guid, string)" /> that uses
        ...
        ///     <see cref="IFeatureChecker.GetValueAsync(Guid, string)" />
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker" /> instance</param>
        ...
        ///     This is a shortcut for <see cref="IsEnabledAsync(IFeatureChecker, Guid, string)" /> that uses
        ///     <see cref="IAbpSession.TenantId" /> as tenantId.
        ///     So, this method should be used only if TenantId can be obtained from the session.
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker" /> instance</param>
        ...
        /// <param name="featureName">Unique feature name</param>
        /// <returns>True, if current feature's value is "true".</returns>
        public static async Task<bool> IsEnabledAsync(this IFeatureChecker featureChecker, Guid tenantId,
            string featureName)
        {
        ...
        /// <param name="requiresAll">True, to require all given features are enabled. False, to require one or more.</param>
        /// <param name="featureNames">Name of the features</param>
        public static bool IsEnabled(this IFeatureChecker featureChecker, Guid tenantId, bool requiresAll,
            params string[] featureNames)
        {
        ...
        /// <param name="requiresAll">True, to require all given features are enabled. False, to require one or more.</param>
        /// <param name="featureNames">Name of the features</param>
        public static async Task CheckEnabledAsync(this IFeatureChecker featureChecker, Guid tenantId, bool requiresAll,
            params string[] featureNames)
        {
            if (featureNames.IsNullOrEmpty())
            {
        ...
        /// <param name="requiresAll">True, to require all given features are enabled. False, to require one or more.</param>
        /// <param name="featureNames">Name of the features</param>
        public static void CheckEnabled(this IFeatureChecker featureChecker, Guid tenantId, bool requiresAll,
            params string[] featureNames)
        {
