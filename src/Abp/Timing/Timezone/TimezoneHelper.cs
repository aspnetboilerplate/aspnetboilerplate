    ...
    public static class TimezoneHelper
    {
        ...
        private static void GetTimezoneMappings()
        {
            ...
            using (var stream = assembly.GetManifestResourceStream(resourceName))
            {
                ...
                var defaultMappingNodes =
                    xmlDocument.SelectNodes("//supplementalData/windowsZones/mapTimezones/mapZone[@territory='001']");
                AddMappingsToDictionary(TimeZoneMappings, defaultMappingNodes);
            }
        }

        private static void AddMappingsToDictionary(Dictionary<string, string> timeZoneMappings,
