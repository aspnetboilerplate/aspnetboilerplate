...
namespace Abp.Domain.Entities.Auditing
{
    public static class EntityAuditingHelper
    {
            ...
            IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            ...
            if (creationUserIdFilter != null && !creationUserIdFilter.IsSavingEnabled) return;
            ...
            IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            ...
            var lastModifierUserIdFilter =
                auditFields?.FirstOrDefault(e => e.FieldName == AbpAuditFields.LastModifierUserId);
            if (lastModifierUserIdFilter != null && !lastModifierUserIdFilter.IsSavingEnabled) return;
            ...
            IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            if (entityAsObj is IHasDeletionTime)
            {
                ...
                if (entity.DeletionTime == null) entity.DeletionTime = Clock.Now;
            }
            ...
            if (entityAsObj is IDeletionAudited)
            {
                ...
                if (entity.DeleterUserId != null) return;
                ...
                if (deleterUserIdFilter != null && !deleterUserIdFilter.IsSavingEnabled) return;
