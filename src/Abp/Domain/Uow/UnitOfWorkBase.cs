...
namespace Abp.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        public IDisposable SetTenantId(Guid? tenantId)
        {
            var oldTenantId = _tenantId;
            _tenantId = tenantId;

            var mayHaveTenantChange = SetFilterParameter(AbpDataFilters.MayHaveTenant,
                AbpDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(AbpDataFilters.MustHaveTenant,
                AbpDataFilters.Parameters.TenantId, tenantId ?? Guid.Empty);
