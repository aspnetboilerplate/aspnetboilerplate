...
namespace Abp.Runtime.Caching.Redis.InMemory
{
    ...
    public interface IAbpRedisInMemoryCache : ICache
    {
        ...
        void SetMemory(string key, object value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null);
        ...
        /// <param name="slidingExpireTime">Sliding expire time</param>
        /// <param name="absoluteExpireTime">Absolute expire time</param>
        Task SetMemoryAsync(string key, object value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null);
