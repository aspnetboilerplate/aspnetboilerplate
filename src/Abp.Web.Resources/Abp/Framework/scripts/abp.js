        ...
        function($) {
            return (function() {
                ...
                abp.auth.setRefreshToken = function(refreshToken, expireDate) {
                    abp.utils.setCookieValue(abp.auth.refreshTokenCookieName,
                        refreshToken,
                        expireDate,
                        abp.appPath,
                        abp.domain);
                ...
                abp.notifications.messageFormatters["Abp.Notifications.MessageNotificationData"] =
                    ...
                    function(userNotification) {
                        ...
                        if (userNotification.notification.data.properties) {
                            if ($) {
                                ...
                                $.each(userNotification.notification.data.properties,
                                    function(key, value) {
                ...
                abp.notifications.getFormattedMessageFromUserNotification = function(userNotification) {
                    ...
                    if (!formatter) {
                        abp.log.warn("No message formatter defined for given data type: " +
                ...
                abp.notifications.showUiNotifyForUserNotification = function(userNotification, options) {
                    ...
                    var uiNotifyFunc =
                        abp.notifications.getUiNotifyFuncBySeverity(userNotification.notification.severity);
                ...
                ************************************************************/
                ...
                abp.timing.convertToUserTimezone = function(date) {
                    ...
                    var targetTime = parseInt(utcTime) +
