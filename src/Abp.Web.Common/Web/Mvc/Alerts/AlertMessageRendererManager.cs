...
namespace Abp.Web.Mvc.Alerts
{
    public class AlertMessageRendererManager : IAlertMessageRendererManager
    {
        ...
        public AlertMessageRendererManager(IEnumerable<IAlertMessageRenderer> alertMessageRenderers,
        ...
        {
            if (!_alertManager.Alerts.Any(a => a.DisplayType == alertDisplayType)) return "";
