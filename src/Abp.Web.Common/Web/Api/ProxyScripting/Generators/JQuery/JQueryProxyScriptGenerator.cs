...
namespace Abp.Web.Api.ProxyScripting.Generators.JQuery
{
    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
    {
        ...
        private static void AddControllerScript(StringBuilder script, ModuleApiDescriptionModel module,
        ...
        private static void AddActionScript(StringBuilder script, ModuleApiDescriptionModel module,
        ...
        private static void AddAjaxCallParameters(StringBuilder script, ControllerApiDescriptionModel controller,
