...
public static class HubCallerContextExtensions
{
    public static int? GetTenantId(this HubCallerContext context)
    {
        ...
        if (string.IsNullOrEmpty(tenantIdClaim?.Value)) return null;
    ...
    public static long GetUserId(this HubCallerContext context)
    {
        ...
        if (userId == null) throw new AbpException("UserId is null! Probably, user is not logged in.");
    ...
    public static long? GetImpersonatorUserId(this HubCallerContext context)
    {
        ...
        var impersonatorUserIdClaim =
            context.User.Claims.FirstOrDefault(c => c.Type == AbpClaimTypes.ImpersonatorUserId);
    ...
    public static long? GetImpersonatorTenantId(this HubCallerContext context)
    {
        ...
        var impersonatorTenantIdClaim =
            context.User.Claims.FirstOrDefault(c => c.Type == AbpClaimTypes.ImpersonatorTenantId);
