...
public class AbpAppServiceConvention : IApplicationModelConvention
{
        ...
        foreach (var controller in application.Controllers)
        {
            ...
            else
            {
                var remoteServiceAtt =
                    ReflectionHelper.GetSingleAttributeOrDefault<RemoteServiceAttribute>(type.GetTypeInfo());
    ...
    {
        if (responseCacheAttribute == null) return;

        if (controller.Filters.Any(filter => typeof(ResponseCacheAttribute).IsAssignableFrom(filter.GetType()))) return;
    ...
    private void ConfigureApiExplorer(ControllerModel controller)
    {
        ...
        if (controller.ApiExplorer.IsVisible == null)
        {
            ...
            var remoteServiceAtt =
                ReflectionHelper.GetSingleAttributeOrDefault<RemoteServiceAttribute>(controllerType.GetTypeInfo());
