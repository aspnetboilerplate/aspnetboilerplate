...
public class AbpLocalizationHeaderRequestCultureProvider : RequestCultureProvider
{
    ...
    public override Task<ProviderCultureResult> DetermineProviderCultureResult(HttpContext httpContext)
    {
        ...
        if (localizationHeader.Count == 0) return Task.FromResult((ProviderCultureResult)null);
        ...
        Logger.DebugFormat("{0} - Using Culture:{1} , UICulture:{2}",
            nameof(AbpLocalizationHeaderRequestCultureProvider), culture, uiCulture);
    ...
    public static ProviderCultureResult ParseHeaderValue(string value)
    {
        ...
        if (!value.Contains("|") && !value.Contains("=")) return new ProviderCultureResult(value, value);
