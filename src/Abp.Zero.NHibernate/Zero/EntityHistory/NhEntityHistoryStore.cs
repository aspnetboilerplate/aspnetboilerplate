    ...
    public class NhEntityHistoryStore : EntityHistoryStore
{
    ...
    public NhEntityHistoryStore(IRepository<EntityChangeSet, long> changeSetRepository, IRepository<EntityChange, long> entityChangeRepository, IRepository<EntityPropertyChange, long> entityPropertyChangeRepository, IUnitOfWorkManager unitOfWorkManager) : base(changeSetRepository, unitOfWorkManager)
    {
