...
namespace Reation.CMS.Articles
{
    ...
    {
        GetArticlesOutput GetArticles(GetArticlesInput input);

        Article UpdateArticle(UpdateArticleInput input);

        Article CreateArticle(CreateArticleInput input);
        ...
        IList<Article> GetAllList();

        Task<List<Article>> GetAllListAsync();
