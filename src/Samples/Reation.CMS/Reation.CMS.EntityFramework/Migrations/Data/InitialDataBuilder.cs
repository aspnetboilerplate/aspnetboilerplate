...
namespace Reation.CMS.Migrations.Data
{
    public class InitialDataBuilder
    {
        public void Build(CMS.EntityFramework.CMSDbContext context)
        {
            context.DisableAllFilters();
          //  CreateUserAndRoles(context);
        }

        //private void CreateUserAndRoles(CMS.EntityFramework.CMSDbContext context)
        //{
