...
namespace Abp.WebApi.Controllers.Dynamic.Builders
{
    internal static class DynamicApiServiceNameHelper
    {
        ...
        private static readonly Regex ServiceNameWithActionRegex =
            new Regex(@"^([a-zA-Z_][a-zA-Z0-9_]*)(\/([a-zA-Z_][a-zA-Z0-9_]*)){2,}$");
        ...
        {
            return serviceNameWithAction.Substring(0,
        ...
        {
            return
                serviceNameWithAction.Substring(
