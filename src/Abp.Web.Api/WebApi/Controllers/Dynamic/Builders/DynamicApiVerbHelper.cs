...
namespace Abp.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal static class DynamicApiVerbHelper
    {
        ...
        {
            if (methodName.StartsWith("Get", StringComparison.InvariantCultureIgnoreCase)) return HttpVerb.Get;
            ...
            if (methodName.StartsWith("Patch", StringComparison.InvariantCultureIgnoreCase)) return HttpVerb.Patch;
