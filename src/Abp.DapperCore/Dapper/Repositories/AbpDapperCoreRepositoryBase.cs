...
{
    /// <summary>
    ///     Base class to implement <see cref="IDapperCoreRepository{TEntity,TPrimaryKey}" />.
    ///     It implements some methods in most simple way.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <typeparam name="TPrimaryKey">The type of the primary key.</typeparam>
    /// <seealso cref="IDapperCoreRepository{TEntity,TPrimaryKey}" />
    public abstract class AbpDapperCoreRepositoryBase<TEntity, TPrimaryKey> : IDapperCoreRepository<TEntity, TPrimaryKey> where TEntity : class, IEntity<TPrimaryKey>
    {
        public static MultiTenancySides? MultiTenancySide { get; private set; }

        static AbpDapperCoreRepositoryBase()
        {
