    ...
    where TStartupModule : AbpModule
{
    ...
    protected override void PreInitialize()
    {
        ...
        LocalIocManager.IocContainer.Register(Component.For<IAbpRedisCacheDatabaseProvider>()
            .Instance(redisDatabaseProvider).LifestyleSingleton().IsDefault());
    }
    ...
    protected PerRequestRedisCacheTestsBase()
    {
        ...
        LocalIocManager.IocContainer.Register(Component.For<IHttpContextAccessor>().Instance(httpContextAccessor)
