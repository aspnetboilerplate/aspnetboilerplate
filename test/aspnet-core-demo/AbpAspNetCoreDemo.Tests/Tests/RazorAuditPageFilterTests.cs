...
#pragma warning disable 4014
        ...
        _auditingStore.Received().SaveAsync(Arg.Is<AuditInfo>(a =>
            a.ServiceName.Contains("AuditFilterPageDemo") && a.Parameters.Contains("My test message")));
...
#pragma warning restore 4014
    ...
    [InlineData("Json")]
    [InlineData("Object")]
    public async Task RazorPage_RazorAuditPageFilter_Set_ReturnValue_When_Return_JsonResult_Or_ObjectResult(
        string handler)
    {
        // Arrange
