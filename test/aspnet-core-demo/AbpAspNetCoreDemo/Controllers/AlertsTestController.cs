...
public class AlertsTestController : DemoControllerBase
{
    public IActionResult Index()
    {
        ...
        Alerts.Danger("Danger toast message!", "Test Toast", false, AlertDisplayType.Toastr);
        Alerts.Warning("Warning toast message!", "Test Toast", false, AlertDisplayType.Toastr);
        Alerts.Info("Info toast message!", "Test Toast", false, AlertDisplayType.Toastr);
        Alerts.Success("Success toast message!", "Test Toast", false, AlertDisplayType.Toastr);
