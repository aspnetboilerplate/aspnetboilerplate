...
{
    public class DapperCoreRepository_Tests : DapperCoreApplicationTestBase
    {
        private readonly IDapperCoreRepository<Product> _productDapperRepository;
        private readonly IRepository<Product> _productRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly IRepository<ProductDetail> _productDetailRepository;
        private readonly IDapperCoreRepository<ProductDetail> _productDetailDapperRepository;

        public DapperCoreRepository_Tests()
        {
            _productRepository = Resolve<IRepository<Product>>();
            _productDapperRepository = Resolve<IDapperCoreRepository<Product>>();
            _unitOfWorkManager = Resolve<IUnitOfWorkManager>();
            _productDetailRepository = Resolve<IRepository<ProductDetail>>();
            _productDetailDapperRepository = Resolve<IDapperCoreRepository<ProductDetail>>();
        }

        [Fact]
        public void DapperCore_Repository_Tests()
        {
