...
public class DateTimeModelBinder_Tests : AppTestBase
{
    ...
    public async Task Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider(string date,
        string expectedKind)
    {
    ...
    public async Task
        Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_When_Not_Normalized_Property(
            string date, string expectedKind)
    {
        var response = await GetResponseAsObjectAsync<AjaxResponse<string>>(
            GetUrl<SimpleTestController>(
    ...
    public async Task Controller_Should_Return_Correct_DateTimeKind_For_Not_Normalized_DateTime_Property(string date,
        string expectedKind)
    {
    ...
    public async Task
        Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_When_Not_Normalized_Class(string date,
            string expectedKind)
    {
        var response = await GetResponseAsObjectAsync<AjaxResponse<string>>(
            GetUrl<SimpleTestController>(
    ...
    [InlineData("2016-04-13 08:58:10.526", "local")]
    [InlineData("2016-04-13 08:58:10.526", "unspecified")]
    public async Task Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_SimpleType(string date,
        string expectedKind)
    {
        Clock.Provider = StringToClockProvider(expectedKind);
    ...
    [InlineData("2016-04-13 08:58:10.526", "unspecified")]
    public async Task
        Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_When_Not_Normalized_Property_SimpleType(
            string date, string expectedKind)
    {
        var response = await GetResponseAsObjectAsync<AjaxResponse<string>>(
            GetUrl<SimpleTestController>(
    ...
    [InlineData("2016-04-13 08:58:10.526", "local")]
    [InlineData("2016-04-13 08:58:10.526", "unspecified")]
    public async Task Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_NullableSimpleType(
        string date, string expectedKind)
    {
        Clock.Provider = StringToClockProvider(expectedKind);
    ...
    [InlineData("2016-04-13 08:58:10.526", "unspecified")]
    public async Task
        Controller_Should_Receive_Correct_DateTimeKind_For_Current_ClockProvider_When_Not_Normalized_Property_NullableSimpleType(
            string date, string expectedKind)
    {
        var response = await GetResponseAsObjectAsync<AjaxResponse<string>>(
            GetUrl<SimpleTestController>(
    ...
    {
        if (dateTimeKind == "local") return ClockProviders.Local;

        if (dateTimeKind == "utc") return ClockProviders.Utc;
