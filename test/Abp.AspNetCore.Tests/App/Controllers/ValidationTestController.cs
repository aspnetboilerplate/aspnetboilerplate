...
public class ValidationTestController : AbpController
{
    ...
    {
        [Range(1, 99)] public int Value { get; set; }
    }
    ...
    public class ValidationTestArgument3 : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (Value <= 0) results.Add(new ValidationResult("Value must be higher than 0", new[] { "value" }));
    ...
    public class ValidationTestArgument4 : ICustomValidate
    {
        ...
        {
            if (Value != "abp") context.Results.Add(new ValidationResult("Value must be \"abp\"", new[] { "value" }));
        }
    }
