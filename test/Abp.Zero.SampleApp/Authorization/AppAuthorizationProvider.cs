...
namespace Abp.Zero.SampleApp.Authorization
{
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            var permission1 =context.CreatePermission("Permission1", new FixedLocalizableString("Permission1"),multiTenancySides:MultiTenancySides.Tenant);
            ...
            var firstLevelChilPermission1 = permission1.CreateChildPermission("FirstLevelChilPermission1", new FixedLocalizableString("FirstLevelChilPermission1"),multiTenancySides:MultiTenancySides.Tenant);
            firstLevelChilPermission1.CreateChildPermission("SecondLevelChildPermission1", new FixedLocalizableString("SecondLevelChildPermission1"),multiTenancySides:MultiTenancySides.Tenant);
        }
    }
}
