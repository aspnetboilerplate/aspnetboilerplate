...
public class TenantRoleAndUserBuilder
{
    ...
    private void CreateRolesAndUsers()
    {
        ...
        var adminRole =
            _context.Roles.FirstOrDefault(r => r.TenantId == _tenantId && r.Name == AppStaticRoleNames.Tenants.Admin);
        if (adminRole == null)
        {
            adminRole = _context.Roles
                .Add(new Role(_tenantId, AppStaticRoleNames.Tenants.Admin, AppStaticRoleNames.Tenants.Admin)
        ...
        var userRole =
            _context.Roles.FirstOrDefault(r => r.TenantId == _tenantId && r.Name == AppStaticRoleNames.Tenants.User);
        if (userRole == null)
        {
        ...
        var adminUser =
            _context.Users.FirstOrDefault(u => u.TenantId == _tenantId && u.UserName == AbpUserBase.AdminUserName);
