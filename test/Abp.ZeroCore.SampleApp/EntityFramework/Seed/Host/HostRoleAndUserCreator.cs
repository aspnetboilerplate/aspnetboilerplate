...
public class HostRoleAndUserCreator
{
    ...
    private void CreateHostRoleAndUsers()
    {
        ...
        var adminRoleForHost =
            _context.Roles.FirstOrDefault(r => r.TenantId == null && r.Name == AppStaticRoleNames.Host.Admin);
        if (adminRoleForHost == null)
        {
            adminRoleForHost = _context.Roles
                .Add(new Role(null, AppStaticRoleNames.Host.Admin, AppStaticRoleNames.Host.Admin)
        ...
        var adminUserForHost =
            _context.Users.FirstOrDefault(u => u.TenantId == null && u.UserName == AbpUserBase.AdminUserName);
        if (adminUserForHost != null) return;
