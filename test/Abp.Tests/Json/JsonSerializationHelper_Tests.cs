...
namespace Abp.Tests.Json
{
    public class JsonSerializationHelper_Tests
    {
        ...
        {
            var str =
                "Abp.Localization.LocalizableString, Abp, Version=1.5.1.0, Culture=neutral, PublicKeyToken=null|{\"SourceName\":\"Bar\",\"Name\":\"Foo\"}";
            var result = (LocalizableString)JsonSerializationHelper.DeserializeWithType(str);
            result.ShouldNotBeNull();
            result.Name.ShouldBe("Foo");
            result.SourceName.ShouldBe("Bar");
        ...
        public void Should_Deserialize_With_DateTime()
        {
            ...
            var str =
                "Abp.Tests.Json.JsonSerializationHelper_Tests+MyClass2, Abp.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null|{\"Date\":\"2016-04-13T16:58:10.526+08:00\"}";
        ...
        public void Should_Deserialize_Without_DateTime_Normalization()
        {
            ...
            var str1 =
                "Abp.Tests.Json.JsonSerializationHelper_Tests+MyClass3, Abp.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null|{\"Date\":\"2016-04-13T16:58:10.526+08:00\"}";
            var result1 = (MyClass3)JsonSerializationHelper.DeserializeWithType(str1);
            result1.ShouldNotBeNull();
            result1.Date.Kind.ShouldBe(DateTimeKind.Local);

            var str2 =
                "Abp.Tests.Json.JsonSerializationHelper_Tests+MyClass4, Abp.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null|{\"Date\":\"2016-04-13T16:58:10.526+08:00\"}";
